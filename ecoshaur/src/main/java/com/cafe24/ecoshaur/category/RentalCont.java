...
//---------------------------------------------------------------------------
   ...
   if(cnt!=1) {
     mav.addObject("msg1", "<script>alert('상품등록에 실패하였습니다'); window.location.href = './Category.do?nowpage=1&col=&search=';</script>");
   } else {
     mav.addObject("msg1", "<script>alert('상품등록에 성공하였습니다'); window.location.href = './Category.do?nowpage=1&col=&search=';</script>");
   }
...
//---------------------------------------------------------------------------
   ...
   if(dto.getPosterMF().getSize() != 0) { // 썸네일 수정을 한다면?
     MultipartFile PosterMF = dto.getPosterMF();
     String poster = UploadSaveManager.saveFileSpring30(PosterMF, basePath);
     dto.setThmb_name(poster);
   }
   ...
   if(dto.getFilenameMF().getSize() != 0) { // 이미지 수정을 한다면?
     MultipartFile filenameMF = dto.getFilenameMF();  
     String image = UploadSaveManager.saveFileSpring30(filenameMF, basePath);
     dto.setImage_name(image);
   }
...
//---------------------------------------------------------------------------
   ...
   if(cnt!=1) {
     mav.addObject("msg1", "<script>alert('상품수정에 실패하였습니다'); window.location.href = './Category.do?nowpage=1&col=&search=';</script>");
   } else {
     mav.addObject("msg1", "<script>alert('상품수정에 성공하였습니다'); window.location.href = './Category.do?nowpage=1&col=&search=';</script>");
   }
...
public ModelAndView Rental_deleteProc(String product_no, HttpServletRequest req) {
 ...
 if(cnt!=1) {
   mav.addObject("msg1", "<script>alert('상품삭제에 실패하였습니다'); window.location.href = './Category.do?nowpage=1&col=&search=';</script>");
 } else {
   mav.addObject("msg1", "<script>alert('상품삭제에 성공하였습니다'); window.location.href = './Category.do?nowpage=1&col=&search=';</script>");
 }
