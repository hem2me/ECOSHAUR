  ...
  //장바구니 삭제
    ...
    public int change_borrow(int order_no, String code) {
      ...
      try {
        ...
        System.out.println("반납신청 코드변경 실패 : " + e);
      } finally {
        DBClose.close(con, pstmt);
      } // try end
      return cnt;
    ...
    public int rental_quantity(String product_no) {
      ...
      try {
        ...
        System.out.println("상품갯수 가져오기 실패 : " + e);
      } finally {
        dbclose.close(con, pstmt);
      }
      return total;
    ...
    public int change_stat(String product_no) {
      ...
      try {
        ...
        System.out.println("상품 상태 변경 실패 : " + e);
      } finally {
        DBClose.close(con, pstmt);
      } // try end
      return cnt;
    ...
    public int change_quantity(String product_no, int quantity) {
      ...
      try {
        ...
        System.out.println("상품 갯수 변경 실패 : " + e);
      } finally {
        DBClose.close(con, pstmt);
      } // try end
      return cnt;
